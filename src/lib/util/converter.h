...
#define trytes_from_trits(...) GET_TRYTES(__VA_ARGS__, trytes_3, trytes_2)(__VA_ARGS__)
#define bytes_from_trits(...) GET_BYTES(__VA_ARGS__, bytes_3, bytes_2)(__VA_ARGS__)
*/
